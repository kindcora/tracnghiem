...
// ============= DANH SÁCH ĐỀ =============
// v2.2.0 - Fix #7: debounce search input (180ms)
let __searchQuizTimer = null;
function debouncedRenderQuizList() {
    clearTimeout(__searchQuizTimer);
    __searchQuizTimer = setTimeout(renderQuizList, 180);
}
window.debouncedRenderQuizList = debouncedRenderQuizList;
...
// ============================================
// Lazy-load Chart.js (v2.2.0 - Fix #6)
...
function ensureChartJs() {
    ...
    __chartJsPromise = new Promise(function(resolve, reject) {
        const s = document.createElement('script');
        s.src = 'https://cdn.jsdelivr.net/npm/chart.js';
        s.async = true;
        s.onload = function() { resolve(); };
        s.onerror = function() { __chartJsPromise = null; reject(new Error('Chart.js failed to load')); };
